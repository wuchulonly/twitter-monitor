  ...
  <div class="app">
    <nav class="sidebar">
      ...
      <div class="nav-links">
        ...
        <router-link to="/tweets" class="nav-item">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
          </svg>
          <span class="nav-label">{{ $t('nav.tweets') }}</span>
        </router-link>

        <router-link to="/monitors" class="nav-item">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
            <circle cx="12" cy="12" r="3"/>
          </svg>
          <span class="nav-label">{{ $t('nav.monitors') }}</span>
        </router-link>
      ...
      <div class="sidebar-footer">
        <div class="sidebar-status">
          ...
          <span class="status-text">{{ $t('status.active') }}</span>
        </div>
        <button class="lang-btn" @click="toggleLang" :title="locale === 'zh-CN' ? 'Switch to English' : '切换到中文'">
          {{ locale === 'zh-CN' ? 'EN' : '中' }}
        </button>
      </div>
    </nav>
...
:root {
  ...
  --danger: #ff3d57;
  --danger-dim: rgba(255, 61, 87, 0.12);
...
.sidebar:hover .lang-btn { opacity: 1; }
.lang-btn:hover {
...
@media (max-width: 768px) {
  ...
  .nav-icon { width: 18px; height: 18px; margin-left: 0; }
